<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Buyer_Log.aspx.cs" Inherits="Buyer_Log" %>
...
<body>
  ...
  <nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
    <div class="container">
      ...
      <a class="navbar-brand text-brand" href="#    ">E_<span class="color-b">Tenders</span></a>
      ...
      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
        <ul class="navbar-nav">
         <%--<li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="Buyer_Reg.aspx">Register</a>
          </li>
        </ul>
      </div>
        ...
        <div class="col-sm-12 section-t8">
          <div class="row">
            <div class="col-md-7">
                ...
                <div id="sendmessage">Enter following details for Login!</div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-12 mb-3">
                    ...
                    <div class="col-md-12 mb-3">
                    <div class="form-group">
                      <input name="password" type="password" class="form-control form-control-lg form-control-a" placeholder="Your Password" data-rule="minlen:4" data-msg="Please enter a valid password" required="required">
                      <div class="validation"></div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-12">
                    <%--<button type="submit" class="btn btn-a">Send Message</button>--%>
                      <asp:Button ID="Button1" runat="server" Text="Submit"  class="btn btn-a" OnClick="Button1_Click"/>
                        ...
                        <a id="HyperLink1" href="admin_login.aspx">Admin_Login</a> 
                  </div>
                </div>
              </form>
            </div>
