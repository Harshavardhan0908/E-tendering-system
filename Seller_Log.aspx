<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Seller_Log.aspx.cs" Inherits="Seller_Log" %>
      ...
      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
        <ul class="navbar-nav">
         <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="Seller_Log.aspx">Login</a>
          </li>
        </ul>
      </div>
      ...
      <div class="row">
        <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
            ...
            <span class="color-text-a">Things you Can Do with Seller Account</span>
