<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Manage_Tender.aspx.cs" Inherits="Tender_Manage_Tender" %>
  ...
  <section class="contact">
    <div class="container">
        ...
        <div class="col-sm-12 section-t8">
                ...
                <div id="sendmessage">Add new Tenders</div>
		  ...
		  <div class="card-deck">
			...
			<%--	<h5 class="card-title"><a href="Add_Property.aspx?msg=add">Add New Property</a></h5>--%>
                  <h5 class="card-title"><a href="AddTender.aspx">Add New Tender</a></h5>
                       ...
                       {%>
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href="AddTender.aspx?id=<%=row.ItemArray[0]%>&msg=edit" class="btn btn-outline-success ">Edit</a></td>
