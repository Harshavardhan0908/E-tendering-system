<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Home.aspx.cs" Inherits="Seller_Home" %>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8">
          ...
          <div class="card-box-c foo">
            <div class="card-header-c d-flex">
              ...
              <div class="card-title-c align-self-center">
                <h2 class="title-c">Buyer</h2>
              </div>
            </div>
            <div class="card-body-c">
              <p class="content-c">
                New properties every hour to help buyers find the right property. Advice from the largest panel of industry experts to help you make smart property decisions.
              </p>
            </div>
            <div class="card-footer-c">
              <%--<a href="Buyer_Log.aspx" class="link-c link-icon">Login </a>
                 <span>|</span>
              <a href="Buyer_Reg.aspx" class="link-c link-icon">Registration </a>--%>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="card-box-c foo">
            <div class="card-header-c d-flex">
              ...
              <div class="card-title-c align-self-center">
                <h2 class="title-c">Land Inspector</h2>
              </div>
            </div>
            <div class="card-body-c">
              <p class="content-c">
                Verify the documents submitted by the land seller and validate and accept the proposal. Blockchain system to provide security to the confidential transactions.
              </p>
            </div>
            <div class="card-footer-c">
             <%-- <a href="#" class="link-c link-icon">Login </a>--%>
             <%-- <a href="#" class="link-c link-icon">egistration </a>--%>
            </div>
          </div>
        </div>
        <div class="col-md-4">
