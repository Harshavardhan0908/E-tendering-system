<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ledger.aspx.cs" Inherits="Tender_Ledger" %>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><%=row["T_date"]%></td>
                                     ...
                                     <td><a href="Block_ledger.aspx?id=<%=row.ItemArray[0]%>&tid=<%=row.ItemArray[1]%>" class="btn btn-outline-success ">View</a></td>
