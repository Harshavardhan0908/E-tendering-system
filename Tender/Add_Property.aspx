<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Add_Property.aspx.cs" Inherits="Buyer_Add_Property" %>
        ...
        <div class="col-sm-12 section-t8">
          <div class="row">
            <div class="col-md-7">
                ...
                <div id="sendmessage">Add Property Details!</div>
                <div id="errormessage"></div>
                <div class="row">
                  <div class="col-md-6 mb-3">
                    <div class="form-group">
                      <input type="text" name="name" class="form-control form-control-lg form-control-a"  placeholder="Property Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required="required" value="<%=_name %>">
                      <div class="validation"></div>
                    </div>
                  </div>
                  <div class="col-md-6 mb-3">
                    <div class="form-group">
                      <input name="area" type="text" class="form-control form-control-lg form-control-a" placeholder="Area"   data-msg="Please enter a valid area" required="required"value="<%=_area %>">
                      <div class="validation"></div>
                    </div>
                  </div>
                  <div class="col-md-6 mb-3">
                    <div class="form-group">
                      ...
                      <select class="form-control form-control-lg form-control-a" id="bedrooms" name="bedrooms" runat="server">
                        <option>Any</option>
                        <option>01</option>
                        <option>02</option>
                        <option>03</option>
                    ...
                    <div class="form-group">
                     <label for="garages">Garages</label>
                      <select class="form-control form-control-lg form-control-a" id="garages" name="garages" runat="server">
                        <option>Any</option>
                        <option>01</option>
                        <option>02</option>
                        <option>03</option>
                ...
                <div class="col-md-6 mb-3">
                    <div class="form-group">
                     <label for="bathrooms">Bathrooms</label>
                      <select class="form-control form-control-lg form-control-a" id="bathrooms"  runat="server" name="bathrooms">
                        <option>Any</option>
                        <option>01</option>
                        <option>02</option>
                        <option>03</option>
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <div class="col-md-12 mb-3">
                    <div class="form-group">
                      <textarea name="Address" class="form-control"  cols="45" rows="8" data-rule="required" data-msg="Please write something for us" placeholder="Address" required="required" ><%=reference %></textarea>
                      <div class="validation"></div>
                    </div>
                  </div>
                <div class="col-md-12 mb-3">
