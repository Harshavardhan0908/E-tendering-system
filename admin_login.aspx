                ...
                <div class="row">
                  ...
                  <div class="col-md-12 mb-3">
                    <div class="form-group">
                      <input name="email" type="text" class="form-control form-control-lg form-control-a" placeholder="Your name"  data-msg="wrong Credits" required="required">
                  ...
                  <div class="col-md-12">
                    <%--<button type="submit" class="btn btn-a">Send Message</button>--%>
                      <asp:Button ID="Button1" runat="server" Text="Submit"  class="btn btn-a" OnClick="Button1_Click"/>
                             ...
                             <a id="HyperLink1" href="Buyer_Log.aspx">Bidder Login</a>  
                  </div>
                </div>
              </form>
            </div>
